        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <View style={{ marginBottom: 8 }}>
              <ThemedText style={{ fontSize: 28, fontWeight: 'bold', marginBottom: 4 }}>
                Edit Profile
              </ThemedText>
            ...
            <View style={{ gap: 12, marginTop: 8 }}>
              ...
              >
                ...
                <ButtonText>{isPending ? 'Updating Profile...' : 'Save Changes'}</ButtonText>
              </Button>
              ...
              <View style={{ 
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                  ...
                  <ThemedText style={{ fontSize: 14, fontWeight: '600', color: theme.destructive }}>
                    Danger Zone
                  </ThemedText>
                </View>
                <ThemedText style={{ fontSize: 12, color: theme.mutedForeground, marginBottom: 12 }}>
